...
<nav>
  <ul>
    ...
    <li><a href="#4">BILL</a></li>
    <li><a href="Logout.php" style="margin-left:700%;">LOGOUT</a></li>
    
  </ul>
</nav>
<!--<div id='infop' style='display:none;'> -->
	<form method="POST" id='doctorform' action="Patient.php"  style='display:none; position:fixed;'class="basic-grey">
	   <h2>Update Info</h2>
	   <hr>
...
<div class="sections">
  ...
  <p5>Address:&nbsp&nbsp&nbsp</p5><p4><?php echo $padd; ?></p4><br>
    <button onclick='showpatient()'style="margin-left:80%; margin-top:-35%">Update Info</button>
...
?>
  ...
  <section id="4" style="overflow:scroll;">
  <h1>BILL</h1>
